...
describe('with invalid parameters', () => {
  it('returns error flag and invalid string message', () => {
    ...
    expect(priorErrorMessages).toContain(ERROR_MESSAGES.invalidString)
  })
  ...
  it('returns error flag and invalid format message', () => {
    ...
    expect(priorHasErrors).toBeTruthy()
    expect(priorErrorMessages).toContain(ERROR_MESSAGES.invalidFormat)
  })
  ...
  it('returns error flag and invalid sum message', () => {
    ...
    expect(priorHasErrors).toBeTruthy()
    expect(priorErrorMessages).toContain(ERROR_MESSAGES.inputSum)
  })
  ...
  it('returns error flag and invalid quantity message', () => {
    ...
    expect(priorHasErrors).toBeTruthy()
    expect(priorErrorMessages).toContain(ERROR_MESSAGES.quantityOfInputs)
  })
})
